...
require (
	github.com/equinor/radix-operator v1.25.0
...
require (
	...
	github.com/equinor/radix-common v1.2.1 // indirect
...
replace cloud.google.com/go/compute v1.6.1 => cloud.google.com/go v0.100.2
